...
class MainActivity2 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.fragment_game2)
        hideLights()
    ...
    private fun updateNickname(){ //hides textView when pressed and shows the editText in order for the player to change nickname
    ...
    private fun changeNickname(view: View){ //updates the textView with the user's nickname
